...
with open('sample1_pickling', 'wb') as pickled_file:
    pickle.dump(movie_name, pickled_file, protocol=0)
    pickle.dump(even, pickled_file, protocol=0)
    pickle.dump(odd, pickled_file, protocol=0)
    pickle.dump(140608, pickled_file, protocol=0)

with open('sample1_pickling', 'rb') as pickled_file:
